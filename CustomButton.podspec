Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "The CustomButton library will simplify the creation of SwiftUI buttons through a single method call by providing the necessary parameters."
